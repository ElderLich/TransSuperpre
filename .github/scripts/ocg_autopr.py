...
def configure(lang: str) -> None:
    global CONFIG, OUTPUT_DIR, BASE_DIR, WORK_DIR, TOOLS_DIR, MAPPINGS_PATH, YPK_URL, CARDS_CDB_URL, JSON_URL
    ...
    MAPPINGS_PATH = Path(env_value("MAPPINGS_PATH", ROOT / "Shared" / "Mappings.csv")).resolve()
